...
url_bonsai      = 'https://drive.google.com/uc?id=1-0wRIB-0pavUOOynklPawwL4nV60rol2'
...
def main():
    ...
    draw_uncurated_result_figure(os.path.join(config.result_dir, 'figure02-uncurated-bonsai.png'), load_Gs(url_bonsai), cx=0, cy=0, cw=512, ch=512, rows=3, lods=[0,0,0,0,0,0], seed=5)
    #draw_style_mixing_figure(os.path.join(config.result_dir, 'figure03-style-mixing.png'), load_Gs(url_bonsai), w=512, h=512, src_seeds=[639,701,687,615,2268], dst_seeds=[888,829,1898,1733,1614,845], style_ranges=[range(0,4)]*3+[range(4,8)]*2+[range(8,18)])
